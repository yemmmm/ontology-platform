...
def relation_type_to_dict(relation_type: RelationTypeModel) -> dict[str, Any]:
    return {
        ...
        "scope_policy": relation_type.scope_policy,
        "symmetric": relation_type.symmetric,
        "transitive": relation_type.transitive,
        "status": relation_type.status,
        "valid_from": getattr(relation_type, "valid_from", None),
        "valid_to": getattr(relation_type, "valid_to", None),
    ...
    for item in payload.relation_types:
        created = metadata_service.create_relation_type(
            ...
            RelationTypeCreate(
                ...
                scope_policy=item.get("scope_policy", "both"),
