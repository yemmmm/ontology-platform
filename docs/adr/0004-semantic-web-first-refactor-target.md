...
`docs/semantic/phase0-technical-foundation.md`. The selected route uses Oxigraph as an independent
...
The detailed Phase 0 output is maintained in `docs/semantic/phase0-technical-foundation.md`.
