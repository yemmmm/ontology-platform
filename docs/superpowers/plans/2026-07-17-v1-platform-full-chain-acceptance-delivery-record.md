...
- Requirement source: `docs/requirements-v1.0.md` R-001～R-008、R-011
- Status: delivered
- Started: 2026-07-17T14:27:35+08:00
- Last updated: 2026-07-17T15:25:34+08:00
- Design: `docs/superpowers/specs/2026-07-17-v1-platform-full-chain-acceptance-design.md`
- Shared test plan: `docs/superpowers/plans/2026-07-17-v1-platform-full-chain-acceptance-test-plan.md`
...
- Evidence: `docs/requirements-v1.0.md`, `docs/requirements-v1.1.md`, `frontend/tests/live-contract.spec.ts`, PostgreSQL opt-in test files.
...
- Evidence: `backend/app/core/config.py`, `backend/app/services/semantic_canonical_write.py`, `docs/superpowers/plans/2026-07-16-r007-operation-semantics-test-plan.md`, and review Round 1.
...
- Evidence: `docs/requirements-v1.0.md` R-008/R-011 and `docs/architecture.md` security boundary.
