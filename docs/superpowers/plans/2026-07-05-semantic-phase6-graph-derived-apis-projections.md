...
**Source spec:** `docs/semantic/phase6-graph-derived-product-apis-projections.md`
...
**Spec coverage check (against `docs/semantic/phase6-graph-derived-product-apis-projections.md`):**
