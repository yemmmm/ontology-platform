...
**Spec:** `docs/delivery/designs/2026-07-08-evidence-postgres-refactor-design.md`
...
### Task 32: Update docs (`CONTEXT.md`, `docs/architecture/semantic/`, ADRs)

**Files:**
- Modify: `CONTEXT.md` (if it mentions evidence storage)
- Modify: `docs/architecture/semantic/` relevant phase docs
