...
**Spec:** `docs/delivery/designs/2026-07-06-semantic-stage1-intake-design.md`
...
| Path | Responsibility | Status |
| --- | --- | --- |
| `docs/delivery/test-plans/semantic-language-integration-test-plan.md` | Add Stage 1 entries | Modify |
...
`docs/architecture/semantic/phase2-namespace-mapping-export.md`); if the names differ, grep for the
...
**Files:**
- Modify: `docs/delivery/test-plans/semantic-language-integration-test-plan.md`

- [ ] **Step 1: Inspect the existing Stage 1 section**

```bash
grep -nE "Stage 1|Intake|build-context|competency-questions" docs/delivery/test-plans/semantic-language-integration-test-plan.md
```
...
```bash
git add docs/delivery/test-plans/semantic-language-integration-test-plan.md
...
Plan complete and saved to `docs/delivery/implementation-plans/2026-07-06-semantic-stage1-intake.md`. Two execution options:
