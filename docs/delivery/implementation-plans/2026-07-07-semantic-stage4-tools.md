...
- **Spec:** `docs/delivery/designs/2026-07-07-semantic-stage4-tools-design.md`
...
**Files:**
- Modify: `docs/delivery/designs/2026-07-07-semantic-stage4-tools-design.md`

- [ ] **Step G2.1:** Flip `**Status:** Draft` to `**Status:** Implemented`.
- [ ] **Step G2.2:** Commit:
  ```bash
  git add docs/delivery/designs/2026-07-07-semantic-stage4-tools-design.md && git commit -m "docs(semantic): mark Stage 4 spec as implemented"
  ```
