...
**Owner:** Agent
**Requirement:** `docs/requirements/requirements-v1.0.md` R-003
...
聚合逻辑。后续由 R-011 对照运行时 registry 删除旧别名并更新 `docs/reference/mcp.md`。
...
- `docs/reference/api.md`、`docs/reference/mcp.md`：记录真实接口和兼容期；
- `docs/requirements/requirements-v1.0.md`：实现后更新状态、提交和验证证据。
