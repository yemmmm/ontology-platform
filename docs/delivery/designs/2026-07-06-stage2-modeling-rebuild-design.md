...
- **Date:** 2026-07-06
- **Scope driver:** `docs/architecture/semantic/functional-semantic-load-inventory.md` → Stage 2 — Modeling / Knowledge
...
`docs/architecture/semantic/functional-semantic-load-inventory.md` Rebuild Order: Classes → Entities →
...
3. Read-model templates and canonical-write kinds marked "Lands with ClassesPage" are
   all live.
4. Stage 2 integration test plan (`docs/delivery/test-plans/semantic-language-integration-test-plan.md`)
...
| Stage 2 integration test plan | `docs/delivery/test-plans/semantic-language-integration-test-plan.md` extended |
