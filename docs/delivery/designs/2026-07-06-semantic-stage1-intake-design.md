...
- **Date:** 2026-07-06
- **Scope driver:** `docs/architecture/semantic/functional-semantic-load-inventory.md` → Stage 1 — Intake
...
- New routes are covered by the semantic language integration smoke suite
  (`docs/delivery/test-plans/semantic-language-integration-test-plan.md`).
...
### 7.2 Integration Smoke (`docs/delivery/test-plans/semantic-language-integration-test-plan.md`)
