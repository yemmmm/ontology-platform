...
本设计细化 `docs/requirements/requirements-v1.0.md` 的 R-006，承接 R-001 默认语义工作区、R-005 统一
...
- MCP registry、surface allowlist、`docs/reference/api.md` 和 `docs/reference/mcp.md` 必须同步。
...
独立测试计划
`docs/delivery/test-plans/2026-07-16-r006-semantic-context-query-test-plan.md` 的 Round 2 结论为
