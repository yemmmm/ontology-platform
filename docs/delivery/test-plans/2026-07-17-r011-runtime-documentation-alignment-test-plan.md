...
- 需求：`docs/requirements/requirements-v1.0.md` R-011。
- 设计：`docs/delivery/designs/2026-07-17-r011-runtime-documentation-alignment-design.md`。
...
- `docs/reference/api.md` 不把旧 Version、Proposal、Catalog、Connector、Neo4j Entity 接口列为当前能力。
- `docs/reference/mcp.md` 不把旧 governance、catalog、entity、fact 工具列为当前能力。
...
1. **High — R-009 详细状态与总表、设计和测试基线矛盾。**
   `docs/requirements/requirements-v1.0.md` 总表把 R-009 标为 `部分实现`，但 R-009 详细条目当前写成
...
- 本轮仍基于 `bb617e6` 的稳定未提交工作树；开发者只修正 Round 1 的 High：
  `docs/requirements/requirements-v1.0.md` R-009 详细状态由 `进行中` 恢复为 `部分实现`，并扩展
