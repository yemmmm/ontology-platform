...
`docs/delivery/designs/2026-07-15-r003-build-context-debug-design.md`。
...
技术设计：`docs/delivery/designs/2026-07-14-r003-build-session-design.md`
...
详细设计：`docs/delivery/designs/2026-07-15-r004-modeling-batch-design.md`；独立验证使用
`docs/delivery/test-plans/2026-07-15-r004-modeling-batch-test-plan.md`。跨 RDF/PostgreSQL 的不确定
写入采用事前持久化计划、Ontology Write Fence 和向前恢复，决策见
`docs/architecture/decisions/0005-forward-recovery-for-modeling-batches.md`。
...
详细设计：`docs/delivery/designs/2026-07-15-r005-unified-lineage-design.md`；独立验证使用
`docs/delivery/test-plans/2026-07-15-r005-lineage-test-plan.md`。
...
详细设计：`docs/delivery/designs/2026-07-16-r006-semantic-context-query-design.md`；独立验证使用
`docs/delivery/test-plans/2026-07-16-r006-semantic-context-query-test-plan.md`。
...
详细设计：`docs/delivery/designs/2026-07-16-r007-operation-semantics-design.md`；独立验证使用
`docs/delivery/test-plans/2026-07-16-r007-operation-semantics-test-plan.md`，Round 2 `PASS`。
...
由 `docs/requirements/requirements-v1.1.md` 中的 R1.1-001 承接。后续若实践证明需要固定数据集、自动执行器
...
- `docs/reference/api.md`、`docs/reference/mcp.md` 只列出真实注册的接口，并说明缺失能力。
