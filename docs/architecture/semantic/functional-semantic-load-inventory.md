...
- ADR `docs/architecture/decisions/0004-semantic-web-first-refactor-target.md`
- Phase 7 `docs/architecture/semantic/phase7-canonical-rdf-dataset-migration.md`
- Phase 8 `docs/architecture/semantic/phase8-frontend-workflow-reshaping.md`
