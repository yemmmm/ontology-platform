...
This project is indexed by GitNexus as **ontology-platform** (10162 symbols, 26865 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
