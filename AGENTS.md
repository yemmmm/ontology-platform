...
This project is indexed by GitNexus as **ontology-platform** (10202 symbols, 26510 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
