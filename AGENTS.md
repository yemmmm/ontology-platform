...
This project is indexed by GitNexus as **ontology-platform** (12667 symbols, 32217 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
